...
ifeq ($(TARGET_BOOT_ANIMATION_RES),720)
     ...
     PRODUCT_COPY_FILES += vendor/extras/themes/bootanimation/bootanimation_1440.zip:$(TARGET_COPY_OUT_PRODUCT)/media/bootanimation.zip
     ...
     PRODUCT_COPY_FILES += vendor/extras/themes/bootanimation/bootanimation_1440.zip:$(TARGET_COPY_OUT_SYSTEM)/media/bootanimation.zip
else
